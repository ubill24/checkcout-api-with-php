...
if (isset($_POST['submit'])) {
    ...
    $checkout_confirm = 'http://localhost:8081/checkout-api-with-php/checkout/checkout_confirm.php';
    $checkout_cancel = 'http://localhost:8081/checkout-api-with-php/checkout/checkout_cancel.php';
    $pay_later_url  = 'http://localhost:8081/checkout-api-with-php/checkout/pay_later.php';
